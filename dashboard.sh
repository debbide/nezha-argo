...
C[1]="哪吒面板 VPS 兼容v0、v1版 (https://github.com/debbide/nezha-argo)\n  - 修改自大佬 fscarmen 的 Argo-Nezha-Service-Container \n  - 告别 Docker！\n  - 告别端口映射！\n  - 告别 IPv4/IPv6 兼容性！"
...
C[4]="必须以root方式运行脚本，可以输入 sudo -i 后重新下载运行，问题反馈:[https://github.com/debbide/nezha-argo/issues]"
...
C[5]="本脚本只支持 Debian、Ubuntu、CentOS、Alpine 或 Arch 系统,问题反馈:[https://github.com/debbide/nezha-argo/issues]"
...
C[6]="当前操作是 \$SYS\\\n 不支持 \$SYSTEM \${MAJOR[int]} 以下系统,问题反馈:[https://github.com/debbide/nezha-argo/issues]"
...
C[22]="Argo 认证信息不符合规则，既不是 Token，也是不是 Json，脚本退出，问题反馈:[https://github.com/debbide/nezha-argo/issues]"
...
C[29]="卸载哪吒面板"
E[30]="Install debbide's VPS with Argo v0,v1 Combined version (https://github.com/debbide/nezha-argo)"
C[30]="安装 debbide 的 VPS argo 带远程备份的v0、v1兼容版 (https://github.com/debbide/nezha-argo)"
E[31]="successful"
C[31]="成功"
E[32]="failed"
C[32]="失败"
E[33]="Could not find \$NEED_PORTS free ports, script exits. Feedback:[https://github.com/debbide/nezha-argo/issues]"
C[33]="找不到 \$NEED_PORTS 个可用端口，脚本退出，问题反馈:[https://github.com/debbide/nezha-argo/issues]"
...
C[34]="重要!!! 请到 Cloudflare 相关域名的 Network 处打开 gRPC 功能，否则客户端数据不通!具体可参照教程: [https://github.com/debbide/nezha-argo]"
